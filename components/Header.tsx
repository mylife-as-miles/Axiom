...
const Header: React.FC = () => {
  return (
    <header className="flex items-center justify-between px-8 py-5 border-b border-[#254632] bg-[#050505]/80 backdrop-blur-md z-10 sticky top-0">
      <div className="flex items-center gap-4">
        <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-[#122118] transition-colors border border-transparent hover:border-[#254632]">
          ...
          <span className="text-lg font-bold tracking-tight">Production-US-East</span>
          <span className="material-symbols-outlined text-gray-500 text-sm">expand_more</span>
        </button>
        <div className="h-6 w-px bg-[#254632]"></div>
      ...
      <div className="flex items-center gap-6">
        <div className="relative group">
          ...
          <input 
            className="bg-[#122118] border border-[#254632] text-sm text-white placeholder-gray-500 rounded-full py-2.5 pl-10 pr-4 w-64 focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all" 
            placeholder="Search metrics, logs, agents..." 
            type="text"
          />
        </div>
        ...
        <button className="p-2 rounded-full hover:bg-[#122118] text-gray-400 hover:text-white transition-colors">
